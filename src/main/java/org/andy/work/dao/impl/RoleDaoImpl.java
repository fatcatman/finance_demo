...
public class RoleDaoImpl implements RoleDao {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<AcctRole> List(int page,int size) {
		List<AcctRole> query = this.getCurrentSession().createQuery("from AcctRole").setFirstResult(page-1).setMaxResults(size).list();
		return query;
	}
