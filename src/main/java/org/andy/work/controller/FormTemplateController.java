...
public class FormTemplateController {
	...
	private static final Logger LOGGER = Logger.getLogger(FormTemplateController.class);
	...
	public @ResponseBody GridDataResult<FormTemplate> List(int page, int limit, int approvalId, HttpSession session){
		...
		try{
			try{
				...
				Approvalitem approvalitem =approvalitemService.getApprovalItem(approval);
				List<FormTemplate> tList = formtemplateService.List(approvalitem,page,limit);
...
//		}
		try
		{
			...
			{
				Approval approval = approvalService.get(-approvalId);
				approvalitem=approvalitemService.getApprovalItem(approval);
			}else{
