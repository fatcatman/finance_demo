...
require.resourceMap({
    "res": {
        ...
        "app/views/parameter/parameter": {
            "deps": [
                "app/services/ajaxService"
            ],
            "url": "/Service//static//modules/app/views/parameter/parameter.js"
        },
        "app/views/employee/employee": {
            "deps": [
                "app/services/ajaxService"
            ],
            "url": "/Service//static//modules/app/views/employee/employee.js"
        },
        "app/views/reportingData/reportingData": {
            "deps": [
                "app/services/ajaxService"
            ],
            "url": "/Service//static//modules/app/views/reportingData/reportingData.js"
        },
        "app/views/welfare/welfare": {
            "deps": [
                "app/services/ajaxService"
            ],
            "url": "/Service//static//modules/app/views/welfare/welfare.js"
        },
        "app/views/org/org": {
            "deps": [
                "app/services/ajaxService"
