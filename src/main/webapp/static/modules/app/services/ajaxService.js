...
exports.parameter = {
	    List: function (page, limit) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Parameter/List.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                page: page,
	    ...
	    save: function (record) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Parameter/Save.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	                id: record.ID,
	    ...
	    Del: function (id) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Parameter/Delete.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                id: id
...
exports.employee = {
	    List: function (page, limit) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Employee/List.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                page: page,
	    ...
	    save: function (record) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Employee/Save.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	                id: record.ID,
	    ...
	    Del: function (id) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Employee/Delete.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                id: id
	    ...
	    excelDownload: function() {
	    	var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Employee/ExcelDownload.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	            }
...
exports.reportingData = {
	    List: function (page, limit, employeeId) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/ReportingData/List.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                page: page,
	    ...
	    save: function (record) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/ReportingData/Save.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	                id: record.ID,
	                reportingMonth: record.ReportingMonth,
	                fundsBase: record.FundsBase,
	                servicePayment: record.ServicePayment,
	                employeeId:record.EmployeeId,
	                isHandled:record.IsHandled,
	                reportingResult:record.ReportingResult,
	                reportingResultDetail:record.ReportingResultDetail
	            }
	        });
	    },
	    doReport: function (id) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/ReportingData/DoReport.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	                reportingDataId: id
	    ...
	    getReportResult: function (id) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/ReportingData/GetReportResult.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	                reportingDataId: id
	    ...
	    Del: function (id) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/ReportingData/Delete.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                id: id
...
exports.welfare = {
	    List: function (page, limit, employeeName, idNumber, reportingMonth, isHandled) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Welfare/List.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                page: page,
	    ...
	    save: function (record) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Welfare/Save.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	                id: record.ID,
	    ...
	    doReport: function (employeeName, idNumber, reportingMonth, isHandled) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Welfare/DoReport.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	            	employeeName: employeeName,
	    ...
	    getReportResult: function (employeeName, idNumber, reportingMonth, isHandled) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Welfare/GetReportResult.do?timeStamp=' + timenow,
	            type: 'post',
	            dataType: 'json',
	            data: {
	            	employeeName: employeeName,
	    ...
	    Del: function (id) {
	        var timenow = new Date().getTime();
	        return lib.ajax({
	            url: '/Service/Welfare/Delete.do?timeStamp=' + timenow,
	            type: 'get',
	            dataType: 'json',
	            data: {
	                id: id
