...
//        });
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            var url;
            switch (color) {
                case 'default': url = '/Service/static/lib/css/default.css'; break;
                case 'blue': url = '/Service/static/lib/css/blue.css'; break;
                case 'brown': url = '/Service/static/lib/css/brown.css'; break;
                case 'purple': url = '/Service/static/lib/css/purple.css'; break;
                case 'grey': url = '/Service/static/lib/css/grey.css'; break;
                case 'light': url = '/Service/static/lib/css/light.css'; break;
            }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="' + '/Service/static/lib/image/ajax-loading.gif' + '" align="">',
