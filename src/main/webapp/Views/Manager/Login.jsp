...
<head>
	...
	<link href="/Service/static/lib/css/default.css" rel="stylesheet" type="text/css" id="style_color"/>
	<link href="/Service/static/lib/css/uniform.default.css" rel="stylesheet" type="text/css"/>
    <link href="/Service/static/lib/page/themes/blue/pace-theme-loading-bar.css" rel="stylesheet" type="text/css"/>
	<!-- END GLOBAL MANDATORY STYLES -->
	<!-- BEGIN PAGE LEVEL STYLES -->
	<link href="/Service/static/lib/css/login-soft.css" rel="stylesheet" type="text/css"/>
	<!-- END PAGE LEVEL STYLES -->
    <!--覆盖字体-->
    <link href="/Service/static/lib/css/customize.css" rel="stylesheet" type="text/css" />
    <link href="/Service/static/lib/css/drag.css" rel="stylesheet" type="text/css" />
...
<body class="login">
	...
	<div class="logo" style="margin-top:40px;">
		<img src="/Service/static/lib/image/logo-index.png" alt="" />
	</div>
	<!-- END LOGO -->
	...
	<script src="/Service/static/lib/jquery/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
    <script src="/Service/static/lib/jquery/jquery.backstretch.min.js" type="text/javascript"></script>
    <script src="/Service/static/lib/jquery/jquery.SuperSlide.2.1.1.js" type="text/javascript"></script>
	<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
	<script src="/Service/static/lib/jquery/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>      
	...
	<![endif]-->   
	<script src="/Service/static/lib/jquery/jquery.slimscroll.min.js" type="text/javascript"></script>
	<script src="/Service/static/lib/jquery/jquery.blockui.min.js" type="text/javascript"></script>  
	<script src="/Service/static/lib/jquery/jquery.cookie.min.js" type="text/javascript"></script>
	<script src="/Service/static/lib/jquery/jquery.uniform.min.js" type="text/javascript" ></script>
	<!-- END CORE PLUGINS -->
    ...
    <script src="/Service/static/lib/drag.js" type="text/javascript"></script>
