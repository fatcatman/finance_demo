...
<head>
	...
	<link href="/static/lib/css/default.css" rel="stylesheet" type="text/css" id="style_color"/>
	<link href="/static/lib/css/uniform.default.css" rel="stylesheet" type="text/css"/>
    <link href="/static/lib/page/themes/blue/pace-theme-loading-bar.css" rel="stylesheet" type="text/css"/>
	<!-- END GLOBAL MANDATORY STYLES -->
	<!-- BEGIN PAGE LEVEL STYLES -->
	<link href="/static/lib/css/login-soft.css" rel="stylesheet" type="text/css"/>
	<!-- END PAGE LEVEL STYLES -->
    <!--覆盖字体-->
    <link href="/static/lib/css/customize.css" rel="stylesheet" type="text/css" />
    <link href="/static/lib/css/drag.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="/static/modules/app/login.js"></script>
...
<body class="login">
	...
	<div class="logo" style="margin-top:40px;">
		<img src="/static/lib/image/logo-index.png" alt="" />
	</div>
	<!-- END LOGO -->
	...
	<script src="/static/lib/jquery/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
    <script src="/static/lib/jquery/jquery.backstretch.min.js" type="text/javascript"></script>
    <script src="/static/lib/jquery/jquery.SuperSlide.2.1.1.js" type="text/javascript"></script>
	<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
	<script src="/static/lib/jquery/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>      
	...
	<![endif]-->   
	<script src="/static/lib/jquery/jquery.slimscroll.min.js" type="text/javascript"></script>
	<script src="/static/lib/jquery/jquery.blockui.min.js" type="text/javascript"></script>  
	<script src="/static/lib/jquery/jquery.cookie.min.js" type="text/javascript"></script>
	<script src="/static/lib/jquery/jquery.uniform.min.js" type="text/javascript" ></script>
	<!-- END CORE PLUGINS -->
    ...
    <script src="/static/lib/drag.js" type="text/javascript"></script>
